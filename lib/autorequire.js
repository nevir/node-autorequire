(function() {
  var Loader, ModuleGroupFactory, autorequire, convention, conventions, file, fs, path, utils, walkDirectory, _i, _len, _ref;
      ...
      if (pathComponent[0] !== '.') {
        ...
        (function(fullPath) {
          ...
          if (pathStats.isDirectory()) {
            return utils.lazyLoad(result, convention.directoryToProperty(pathComponent, basePath), function() {
              return walkDirectory(fullPath, convention);
            });
          } else if (pathStats.isFile()) {
            componentName = convention.fileToProperty(pathComponent, basePath);
            return utils.lazyLoad(result, componentName, function() {
